...
const GoiTest = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await axiosInstance.get("/goi");
            ...
            <div className="max-w-screen w-full md:mx-10 mx-5 bg-pale text-brokenwhite py-5 md:px-6 px-4 rounded-[25px]">
              <div className="sm:text-3xl text-xl">
                <div className="flex items-center justify-center py-5">
                  <img src={question.attach} alt="" /> <br />
              ...
              <div className="flex items-center justify-center mb-5">
                <div
                  ...
                  <div className="mb-6">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800">Sertifikat Evaluasi Japanese Foundation Test</h1>
                  ...
                  <div className="mt-10 mb-10">
                    ...
                    <p className="text-lg text-gray-700 mt-4">
                      Untuk penyelesaian latihan soal <strong>Goi-Kotoba</strong> pada tanggal{" "}
