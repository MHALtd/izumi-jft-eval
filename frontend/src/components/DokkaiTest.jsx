...
const DokkaiTest = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await axiosInstance.get("/dokkai");
  ...
  const next = () => {
    if (lock) {
      if (index === selectedQuestions.length - 1) {
        setResult(true);
        setCanPrintCertificate(score >= 8);
        return;
      }
      setIndex(index + 1);
  ...
  const handleDownloadCertificate = () => {
    if (!canPrintCertificate) {
      alert("You need at least 8 correct answers to print the certificate.");
      return;
    }
    alert("Downloading...");
            ...
            <div className="max-w-screen w-full md:mx-10 mx-5 bg-pale text-brokenwhite py-5 md:px-6 px-4 rounded-[25px]">
              <div className="sm:text-2xl text-xl">
                <div className="flex items-center justify-center py-5">
                  <img src={question.attach} alt="dokkai-question" />
                </div>
                <h1 className="text-2xl sm:text-3xl p-4 flex items-center justify-center">{question.questionText}</h1>
                <div className="flex items-center justify-center">
                  <ul className="grid grid-cols-1 sm:grid-cols-3 gap-4 cursor-pointer my-5">
              ...
              <div className="sm:text-2xl text-xl">
                <div className="grid place-items-center space-y-5">
                  ...
                  <h1 className="text-xl text-center sm:text-2xl">
                    Untuk bisa mencetak sertifikat, kamu perlu menjawab 8 soal benar.
                  </h1>
                ...
                <div
                  ...
                  <div className="mt-10 mb-10">
                    ...
                    <p className="text-lg text-gray-700 mt-4">
                      Untuk penyelesaian latihan soal <strong>Dokkai</strong> pada tanggal{" "}
